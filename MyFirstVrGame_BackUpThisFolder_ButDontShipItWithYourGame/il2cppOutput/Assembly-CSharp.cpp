...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void SimpleCameraController_Update_mBCD24408A4A2C4053F2F98DB808BD6DE88CA998F (SimpleCameraController_t362F9BE95366F2B6BF1D5369EA29E331DDFDCC42 * __this, const RuntimeMethod* method)
{
	...
	float V_2 = 0.0f;
	{
		...
		CameraState_t67204999380EA316F8E1B6C902D4330646DE6AE7 * L_1 = __this->get_m_TargetCameraState_4();
		Vector3_tDCF05E21F632FE2BA260C06E0D10CA81513E6720  L_2 = V_0;
		NullCheck(L_1);
		CameraState_Translate_m76BCC104A48EA7F125D5A50D874A2DEEA7967247(L_1, L_2, /*hidden argument*/NULL);
		// var positionLerpPct = 1f - Mathf.Exp((Mathf.Log(1f - 0.99f) / positionLerpTime) * Time.deltaTime);
		IL2CPP_RUNTIME_CLASS_INIT(Mathf_tFBDE6467D269BFE410605C7D806FD9991D4A89CB_il2cpp_TypeInfo_var);
		float L_3 = logf((0.00999999f));
		float L_4 = __this->get_positionLerpTime_7();
		float L_5 = Time_get_deltaTime_m16F98FC9BA931581236008C288E3B25CBCB7C81E(/*hidden argument*/NULL);
		float L_6 = expf(((float)il2cpp_codegen_multiply((float)((float)((float)L_3/(float)L_4)), (float)L_5)));
		V_1 = ((float)il2cpp_codegen_subtract((float)(1.0f), (float)L_6));
		// var rotationLerpPct = 1f - Mathf.Exp((Mathf.Log(1f - 0.99f) / rotationLerpTime) * Time.deltaTime);
		float L_7 = logf((0.00999999f));
		float L_8 = __this->get_rotationLerpTime_9();
		float L_9 = Time_get_deltaTime_m16F98FC9BA931581236008C288E3B25CBCB7C81E(/*hidden argument*/NULL);
		float L_10 = expf(((float)il2cpp_codegen_multiply((float)((float)((float)L_7/(float)L_8)), (float)L_9)));
		V_2 = ((float)il2cpp_codegen_subtract((float)(1.0f), (float)L_10));
		// m_InterpolatingCameraState.LerpTowards(m_TargetCameraState, positionLerpPct, rotationLerpPct);
		CameraState_t67204999380EA316F8E1B6C902D4330646DE6AE7 * L_11 = __this->get_m_InterpolatingCameraState_5();
		CameraState_t67204999380EA316F8E1B6C902D4330646DE6AE7 * L_12 = __this->get_m_TargetCameraState_4();
		float L_13 = V_1;
		float L_14 = V_2;
		NullCheck(L_11);
		CameraState_LerpTowards_m883AAF2D3C7F5045B64CAF655FB84EF0FC98F282(L_11, L_12, L_13, L_14, /*hidden argument*/NULL);
		// m_InterpolatingCameraState.UpdateTransform(transform);
		CameraState_t67204999380EA316F8E1B6C902D4330646DE6AE7 * L_15 = __this->get_m_InterpolatingCameraState_5();
		...
		NullCheck(L_15);
		CameraState_UpdateTransform_mE3349362276789C1617C01276F7DE533BBA22623(L_15, L_16, /*hidden argument*/NULL);
		// }
		return;
	}
}
